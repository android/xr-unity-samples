// <copyright file="PaintSplashMeshDebugger.cs" company="Google LLC">
//
...
{
    /// <summary>
    /// Show mesh debug info for Paint Splash when it is in the debug mode.
    /// </summary>
    public class PaintSplashMeshDebugger : MeshDebugger
    {
